...
volatile const uint8_t StrobeOut2[] = {(0),                 //000
                                       (BIT3),              //100
                                       (BIT4),              //010
                                       (BIT3 | BIT4),       //110
                                       (BIT5)               //001
...
void TA1_N_IRQHandler (void){
    ...
    if((TimerCount == 16)){
        ...
        P2->OUT &= ~StrobePins2;
        P3->OUT |= RemCLKOUT;
        P6->OUT |= StrobeOut1[StrobeSpot];
        P2->OUT |= StrobeOut2[StrobeSpot];
